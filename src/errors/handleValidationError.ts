...
const ERROR_PATTERNS = [
  {
    ...
    errorMessage: (match: RegExpMatchArray) => match[0],
  },
  {
  ...
  },
  {
    ...
    errorMessage: (match: RegExpMatchArray) =>
      `Invalid or missing value for ${match[1]}`,
  },
  {
    ...
    errorMessage: (match: RegExpMatchArray) =>
      `Unknown argument ${match[1]}. Did you mean ${match[2]}?`,
  },
]
...
const handleValidationError = (
  ...
  return {
    ...
    errorMessages: [
      {
        path: errorPath, // Field or argument name
