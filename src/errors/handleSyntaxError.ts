// import common error message from interface
 ...
 */
const extractSyntaxErrorDetails = (errorMessage: string) => {
 ...
 */
const handleSyntaxError = (error: SyntaxError): IGenericErrorResponse => {
