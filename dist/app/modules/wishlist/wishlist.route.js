...
router.post(
  ...
  wishlist_controller_1.WishlistController.addWishlist,
)
...
router.patch(
  ...
  wishlist_controller_1.WishlistController.updateWishlist,
)
router.delete(
  '/:id',
  (0, auth_1.default)(
  ...
  wishlist_controller_1.WishlistController.deleteWishlist,
)
