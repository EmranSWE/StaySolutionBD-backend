...
const getWishlist = (filters, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getSingleWishlist = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateWishlist = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      (existingWishlist === null || existingWishlist === void 0
        ? void 0
        : existingWishlist.renterId) !== userId
    ) {
      return {
        success: false,
...
const deleteWishlist = (authUser, deletedId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      ...
      throw new ApiError_1.default(
        400,
        "You haven't permission to delete the Wishlist",
      )
    }
