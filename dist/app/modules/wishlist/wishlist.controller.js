...
const addWishlist = (0, catchAsync_1.default)((req, res, next) =>
...
const getWishlist = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const options = (0, pick_1.default)(
      req.query,
      wishlist_constant_1.IWishlistQueryOption,
    )
...
const getSingleWishlist = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const WishlistId = req.params.id
    const result =
      yield wishlist_service_1.WishlistService.getSingleWishlist(WishlistId)
    ;(0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
      success: true,
...
const updateWishlist = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (req.body.data) {
    ...
    const result =
      yield wishlist_service_1.WishlistService.updateWishlist(payload)
    res.status(200).json({
      success: true,
...
const deleteWishlist = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const WishlistId = req.params.id
    const ids = req.user
    const result = yield wishlist_service_1.WishlistService.deleteWishlist(
      ids,
      WishlistId,
    )
    ;(0, sendResponse_1.default)(res, {
