...
const addPaymentStripe = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { user, body } = payload
    ...
    //@ts-ignore
    const { description, monthlyRent } =
      booking === null || booking === void 0 ? void 0 : booking.property
...
//Get all payments
const getPayments = (filters, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getAllRent = (filters, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { limit, page, skip } =
      paginationHelper_1.paginationHelpers.calculatePagination(options)
    const { searchTerm, paymentStatus, paymentAmount } = filters,
    ...
    result.forEach(payment => {
      ...
      groupedByMonth[month].push({
        flatNo:
          ((_b =
            (_a = payment.booking) === null || _a === void 0
              ? void 0
              : _a.property) === null || _b === void 0
            ? void 0
            : _b.flatNo) || null,
