...
const addMarketplace = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const uploadedImage =
      yield FileUploadHelper_1.FileUploadHelper.uploadToCloudinary(file.buffer)
    if (
...
const getMarketplaces = (filters, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { limit, page, skip } =
      paginationHelper_1.paginationHelpers.calculatePagination(options)
    const { searchTerm, price, category } = filters,
      filterData = __rest(filters, ['searchTerm', 'price', 'category'])
    const andConditions = []
    ...
    if (Object.keys(filterData).length > 0) {
      andConditions.push({
        AND: Object.keys(filterData).map(key => {
          if (
            marketplace_constant_1.marketplaceRelationalFields.includes(key)
          ) {
            return {
...
const getSingleMarketplace = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
    const model = prisma_1.default.marketplace
    const result = yield (0, utils_1.getUniqueRecord)(model, payload)
    return result
  })
//Update Marketplace
const updateMarketplace = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b
    if (
    ...
    if (
      (existingMarketplace === null || existingMarketplace === void 0
        ? void 0
        : existingMarketplace.ownerId) !== userId
    ) {
      return {
        success: false,
        error: 'Unauthorized: You cannot update this user',
...
const deleteMarketplace = (authUser, deletedId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      ...
      throw new ApiError_1.default(
        400,
        "You haven't permission to delete the Marketplace",
      )
    }
...
const singleUserMarketplace = userId =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.marketplace.findMany({
