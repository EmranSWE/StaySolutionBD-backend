...
router.post(
  ...
  (0, validateRequest_1.default)(
    issue_validation_1.IssueValidation.CreateIssueZodSchema,
  ),
  issue_controller_1.IssueController.addIssue,
)
...
router.patch(
  ...
  (0, validateRequest_1.default)(
    issue_validation_1.IssueValidation.UpdateIssueZodSchema,
  ),
...
router.delete(
  ...
  issue_controller_1.IssueController.deleteIssue,
)
