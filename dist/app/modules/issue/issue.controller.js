...
const addIssue = (0, catchAsync_1.default)((req, res, next) =>
...
const getIssues = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(
      req.query,
      issue_constant_1.IIssueFilterableFields,
    )
    const options = (0, pick_1.default)(
      req.query,
      issue_constant_1.IIIssueQueryOption,
    )
    const result = yield issue_service_1.IssueService.getProperties(
      filters,
      options,
    )
    ;(0, sendResponse_1.default)(res, {
...
const getSingleIssue = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateIssue = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const payload = {
      body: req.body,
      params: req.params,
...
const deleteIssue = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const IssueId = req.params.id
    const ids = req.user
