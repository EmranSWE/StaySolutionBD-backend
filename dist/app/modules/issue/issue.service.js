...
const addIssue = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const _a = payload.body,
      { propertyId } = _a,
      issueData = __rest(_a, ['propertyId'])
    ...
    const result = yield prisma_1.default.issue.create({
      data: Object.assign(Object.assign({}, issueData), {
        user: {
          connect: {
            id: userId,
          },
...
const getProperties = (filters, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { searchTerm, issueStatus, priorityLevel, monthlyRent } = filters,
...
const updateIssue = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _b, _c
    if (
      !((_b = payload.params) === null || _b === void 0 ? void 0 : _b.id) ||
      !((_c = payload.user) === null || _c === void 0 ? void 0 : _c.id)
    ) {
    ...
    if (
      (existingIssue === null || existingIssue === void 0
        ? void 0
        : existingIssue.renterId) !== userId &&
      role !== 'admin'
    ) {
      return {
        success: false,
    ...
    const { propertyId, renterId } = body,
      restData = __rest(body, ['propertyId', 'renterId'])
...
const deleteIssue = (authUser, deletedId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      ...
      throw new ApiError_1.default(
        400,
        "You haven't permission to delete the Issue",
      )
    }
