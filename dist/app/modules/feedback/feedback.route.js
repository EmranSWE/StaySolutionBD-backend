...
router.delete(
  ...
  feedback__controller_1.FeedbackController.deleteFeedback,
)
router.post(
  '/',
  (0, auth_1.default)(
  ...
  feedback__controller_1.FeedbackController.addFeedback,
)
router.get('/', feedback__controller_1.FeedbackController.getAllFeedbacks)
router.get(
  '/my-feedback/:id',
  feedback__controller_1.FeedbackController.singleUserFeedback,
)
...
router.patch(
  ...
  feedback__controller_1.FeedbackController.updateFeedback,
)
