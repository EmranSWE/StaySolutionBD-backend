...
const addFeedback = (0, catchAsync_1.default)((req, res, next) =>
...
const getAllFeedbacks = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield feedback_service_1.FeedbackService.getAllFeedbacks(options)
    ;(0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
      success: true,
...
const deleteFeedback = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a
    const FeedbackId = req.params.id
    const ids = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id
    const result = yield feedback_service_1.FeedbackService.deleteFeedback(
      ids,
      FeedbackId,
    )
    ;(0, sendResponse_1.default)(res, {
...
const singleUserFeedback = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const userId = req.params.id
    const result =
      yield feedback_service_1.FeedbackService.singleUserFeedback(userId)
    ;(0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
      success: true,
...
//Get a single Feedback
const updateFeedback = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const data = req.body
...
//Get a single Feedback
const getSingleFeedback = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const feedbackId = req.params.id
    const result =
      yield feedback_service_1.FeedbackService.getSingleFeedback(feedbackId)
    ;(0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
      success: true,
