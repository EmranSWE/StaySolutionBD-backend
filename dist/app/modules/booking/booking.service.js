...
const getBookings = (filters, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { limit, page, skip } =
      paginationHelper_1.paginationHelpers.calculatePagination(options)
    const { searchTerm, bookingStatus, bookingStartDate } = filters,
...
const getSingleUserBooking = userId =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.booking.findMany({
      where: {
        renterId: userId,
...
const deleteBooking = (authUser, deletedId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isBooked.renterId !== id && role !== 'admin' && role !== 'owner') {
      throw new ApiError_1.default(
        400,
        "You haven't permission to delete the Booking",
      )
    }
