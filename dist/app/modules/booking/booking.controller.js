...
const addBooking = (0, catchAsync_1.default)((req, res, next) =>
...
const getBookings = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const options = (0, pick_1.default)(
      req.query,
      booking_constant_1.IBookingQueryOption,
    )
...
const getSingleBooking = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const BookingId = req.params.id
    const result =
      yield booking_service_1.BookingService.getSingleBooking(BookingId)
    ;(0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
      success: true,
...
const getSingleUserBooking = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a
    const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id
    const result =
      yield booking_service_1.BookingService.getSingleUserBooking(userId)
    ;(0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
      success: true,
...
const updateBooking = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (req.body.data) {
      req.body = JSON.parse(req.body.data)
    }
...
const deleteBooking = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const BookingId = req.params.id
    const ids = req.user
