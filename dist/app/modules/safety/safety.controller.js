...
const addSafety = (0, catchAsync_1.default)((req, res, next) =>
...
const getSafeties = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(
      req.query,
      safety_constant_1.SafetyFilterableFields,
    )
    const options = (0, pick_1.default)(
      req.query,
      safety_constant_1.ISafetyQueryOption,
    )
    const result = yield safety_service_1.SafetyService.getProperties(
      filters,
      options,
    )
    ;(0, sendResponse_1.default)(res, {
...
const getSingleSafety = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const SafetyId = req.params.id
    const result =
      yield safety_service_1.SafetyService.getSingleSafety(SafetyId)
    ;(0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
      success: true,
...
const updateSafety = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const payload = {
      body: req.body,
      params: req.params,
...
const deleteSafety = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const SafetyId = req.params.id
    const ids = req.user
    const result = yield safety_service_1.SafetyService.deleteSafety(
      ids,
      SafetyId,
    )
    ;(0, sendResponse_1.default)(res, {
