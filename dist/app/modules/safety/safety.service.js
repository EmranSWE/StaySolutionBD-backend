...
const getProperties = (filters, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { searchTerm, safetyScore } = filters,
      filterData = __rest(filters, ['searchTerm', 'safetyScore'])
    const andConditions = []
...
const deleteSafety = (authUser, deletedId) =>
  __awaiter(void 0, void 0, void 0, function* () {
