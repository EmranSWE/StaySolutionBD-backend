...
router.post(
  ...
  (0, validateRequest_1.default)(
    safety_validation_1.SafetyValidation.CreateSafetyZodSchema,
  ),
  safety_controller_1.SafetyController.addSafety,
)
...
router.patch(
  ...
  (0, validateRequest_1.default)(
    safety_validation_1.SafetyValidation.UpdateSafetyZodSchema,
  ),
  safety_controller_1.SafetyController.updateSafety,
)
router.delete(
  '/:id',
  (0, auth_1.default)(
  ...
  safety_controller_1.SafetyController.deleteSafety,
)
