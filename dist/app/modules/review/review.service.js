...
const getAllReviews = (filters, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const deleteReview = (authId, deletedId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      (isSameUser === null || isSameUser === void 0
        ? void 0
        : isSameUser.renterId) !== authId
    ) {
      throw new ApiError_1.default(
        400,
        "You haven't permission to change the review",
      )
    }
...
const singlePropertiesRating = propertyId =>
  __awaiter(void 0, void 0, void 0, function* () {
