...
const addReview = (0, catchAsync_1.default)((req, res, next) =>
...
const getAllReviews = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const options = (0, pick_1.default)(
      req.query,
      user_constants_1.IReviewQueryOption,
    )
...
const getSingleReview = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const reviewId = req.params.id
    const result =
      yield review_service_1.ReviewService.getSingleReview(reviewId)
    ;(0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
      success: true,
...
const updateReview = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (req.body.data) {
      req.body = JSON.parse(req.body.data)
    }
...
const deleteReview = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a
    const reviewId = req.params.id
...
//Get a single review
const singleUserReview = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
//Get a single review
const singlePropertiesRating = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const propertyId = req.params.id
    const result =
      yield review_service_1.ReviewService.singlePropertiesRating(propertyId)
    ;(0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
      success: true,
