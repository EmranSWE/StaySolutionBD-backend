...
const addRegularMonthlyRentPayment = (0, catchAsync_1.default)(
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const payload = {
        body: req.body,
      ...
      const result =
        yield monthlyRentPayment_service_1.MonthlyRentPaymentService.addRegularMonthlyRentPayment(
          payload,
        )
      ;(0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
...
const getCurrentMonthPayments = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a
    const propertyId =
      (_a = req.params) === null || _a === void 0 ? void 0 : _a.id
    const result =
      yield monthlyRentPayment_service_1.MonthlyRentPaymentService.getCurrentMonthPayments(
        propertyId,
      )
    ;(0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
...
const getMonthWiseMonthlyRentPayment = (0, catchAsync_1.default)(
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const result =
        yield monthlyRentPayment_service_1.MonthlyRentPaymentService.getMonthWiseMonthlyRentPayment()
      ;(0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
        message: 'MonthlyRentPayments fetched successfully',
...
const getFlatStatus = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result =
      yield monthlyRentPayment_service_1.MonthlyRentPaymentService.getFlatStatus()
    ;(0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
      success: true,
...
// Getting a single MonthlyRentPayment
const getSingleUserMonthlyRentPayment = (0, catchAsync_1.default)(
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      var _b
      const renterId =
        ...
        _b === void 0
          ...
          : _b.id
      const result =
        yield monthlyRentPayment_service_1.MonthlyRentPaymentService.getSingleUserMonthlyRentPayment(
          renterId,
        )
      ;(0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
...
const deleteMonthlyRentPayment = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const MonthlyRentPaymentId = req.params.id
    const ids = req.user
    const result =
      yield monthlyRentPayment_service_1.MonthlyRentPaymentService.deleteMonthlyRentPayment(
        ids,
        MonthlyRentPaymentId,
      )
    ;(0, sendResponse_1.default)(res, {
