...
const getFeaturedProperties = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result =
      yield property_service_1.PropertyService.getFeaturedProperties()
    ;(0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
      success: true,
      message: 'Properties fetched successfully',
...
const singleUserProperty = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const userId = req.params.id
    const result =
      yield property_service_1.PropertyService.singleUserProperty(userId)
    ;(0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
      success: true,
...
const singleRenterProperty = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const renterId = req.params.id
    const result =
      yield property_service_1.PropertyService.singleRenterProperty(renterId)
    ;(0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
      success: true,
      message: 'Get a my user all Property',
...
//Get a single Renter Property
const popularCategory = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
