...
router.post(
  '/',
  (0, auth_1.default)(user_1.ENUM_USER_ROLE.OWNER),
  FileUploadHelper_1.FileUploadHelper.upload.single('file'),
  property_controller_1.PropertyController.addProperty,
)
router.get(
  '/popular-category',
  property_controller_1.PropertyController.popularCategory,
)
router.get('/', property_controller_1.PropertyController.getProperties)
router.get(
  '/featured-property',
  property_controller_1.PropertyController.getFeaturedProperties,
)
router.get('/:id', property_controller_1.PropertyController.getSingleProperty)
router.patch(
  '/:id',
  (0, auth_1.default)(user_1.ENUM_USER_ROLE.OWNER, user_1.ENUM_USER_ROLE.ADMIN),
  FileUploadHelper_1.FileUploadHelper.upload.single('file'),
...
router.delete(
  ...
  property_controller_1.PropertyController.deleteProperty,
)
router.delete(
  '/:id',
  (0, auth_1.default)(
...
router.get(
  '/my-property/:id/',
  property_controller_1.PropertyController.singleUserProperty,
)
router.get(
  '/properties/:id/my-property',
  (0, auth_1.default)(user_1.ENUM_USER_ROLE.RENTER),
  property_controller_1.PropertyController.singleRenterProperty,
)
