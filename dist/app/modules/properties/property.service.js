...
const getProperties = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { searchTerm, numberOfRooms, availableAfter, monthlyRent, location, size, maxOccupancy, propertyStatus } = filters, filterData = __rest(filters, ["searchTerm", "numberOfRooms", "availableAfter", "monthlyRent", "location", "size", "maxOccupancy", "propertyStatus"]);
    const andConditions = [];
...
const updateProperty = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if ((existingProperty === null || existingProperty === void 0 ? void 0 : existingProperty.ownerId) !== userId) {
        return {
            success: false,
            error: 'Unauthorized: You cannot update this user',
        };
